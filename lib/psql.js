...
var types = require('pg/lib/types');
...
var PSQL = function(connectionParams, poolParams) {
    ...
    pg.defaults.poolSize = poolParams.size || 16;

    // Milliseconds of idle time before removing connection from pool
    pg.defaults.poolIdleTimeout = poolParams.idleTimeout || 30000;

    // Frequency to check for idle clients within the pool, ms
    pg.defaults.reapIntervalMillis = poolParams.reapInterval || 1000;
